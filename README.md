...
it with Maven. This needs the above JDK, downloading of dependency [chariot-0.2.8.jar](https://repo1.maven.org/maven2/io/github/tors42/chariot/0.2.8/chariot-0.2.8.jar) and providing command-line flags:

    $ java --enable-preview -p chariot-0.2.8.jar --add-modules chariot src/main/java/bot/Bot.java
