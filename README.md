...
it with Maven. This needs the above JDK, downloading of dependency [chariot-0.2.9.jar](https://repo1.maven.org/maven2/io/github/tors42/chariot/0.2.9/chariot-0.2.9.jar) and providing command-line flags:
